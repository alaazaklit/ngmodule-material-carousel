...
export declare class MatCarouselSlideComponent implements ListKeyManagerOption, MatCarouselSlide, OnInit {
    ...
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<MatCarouselSlideComponent, "mat-carousel-slide", never, { "overlayColor": "overlayColor"; "hideOverlay": "hideOverlay"; "disabled": "disabled"; "image": "image"; }, {}, never, ["*"], false, never>;
}
